...
public enum ProgressToken {
    ...
    Politic("politic","A la fin de la partie, " //
            + "gagnez 1 Point de victoire par îcone 'chat', présente sur vos cartes bleues", //
            "token-politic.png"),

    Strategy("strategy","A la fin de la partie, " //
    ...
    private ProgressToken(String displayName, String effectDescription, String imageResource) {
